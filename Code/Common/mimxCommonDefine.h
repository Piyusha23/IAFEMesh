...
typedef enum {
  // Image Types
  MIMX_IMAGE_UNKNOWN_TYPE   = 0,
  MIMX_IMAGE_UNSIGNED_8BIT  = 1,
  MIMX_IMAGE_SIGNED_16BIT   = 2,
  MIMX_IMAGE_FLOAT_32BIT    = 3,
  
  MIMX_NUMBER_OF_IMAGE_TYPES
} MIMXImageType;
