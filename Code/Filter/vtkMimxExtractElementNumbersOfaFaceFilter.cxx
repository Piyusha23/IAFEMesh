...
vtkCxxRevisionMacro(vtkMimxExtractElementNumbersOfaFaceFilter, "$Revision: 1.1.1.1 $");
  ...
  vtkInformationVector *outputVector)
{
  ...
  if(!this->ElementSetName)
  {
	...
	//vtkIntArray *elementnumbers = vtkIntArray::SafeDownCast(FeMesh->GetCellData()->GetArray("Element_Numbers"));
