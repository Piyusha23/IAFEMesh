/*=========================================================================
  ...
  Module:    $RCSfile: vtkMimxContourLineInterpolator.h,v $
...
=========================================================================*/
// .NAME vtkMimxContourLineInterpolator - Defines API for interpolating/modifying nodes from a vtkMimxContourRepresentation
// .SECTION Description 
// vtkMimxContourLineInterpolator is an abstract base class for interpolators
...
#ifndef __vtkMimxContourLineInterpolator_h
#define __vtkMimxContourLineInterpolator_h

#include "vtkObject.h"
#include "vtkMimxWidgetsWin32Header.h"

class vtkRenderer;
class vtkMimxContourRepresentation;
class vtkIntArray;

class VTK_MIMXWIDGETS_EXPORT vtkMimxContourLineInterpolator : public vtkObject
{
public:
  // Description:
  // Standard methods for instances of this class.
  vtkTypeRevisionMacro(vtkMimxContourLineInterpolator,vtkObject);
 ...
 protected:
  vtkMimxContourLineInterpolator();
  ~vtkMimxContourLineInterpolator();

private:
  vtkMimxContourLineInterpolator(const vtkMimxContourLineInterpolator&);  //Not implemented
  void operator=(const vtkMimxContourLineInterpolator&);  //Not implemented
};
