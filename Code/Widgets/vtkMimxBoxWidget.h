/*=========================================================================
  ...
  Module:    $RCSfile: vtkMimxBoxWidget.h,v $
...
=========================================================================*/
// .NAME vtkMimxBoxWidget - orthogonal hexahedron 3D widget
// .SECTION Description
...
// nice feature of the object is that the vtkMimxBoxWidget, like any 3D widget,
// will work with the current interactor style. That is, if vtkMimxBoxWidget does
...
// vtkMimxBoxWidget will terminate the processing of the event that it handles.
//
// To use this object, just invoke SetInteractor() with the argument of the
// method a vtkRenderWindowInteractor.  You may also wish to invoke
// "PlaceWidget()" to initially position the widget. The interactor will act
// normally until the "i" key (for "interactor") is pressed, at which point the
// vtkMimxBoxWidget will appear. (See superclass documentation for information
...
// rotate vtkMimxBoxWidget, pick a face (but not a face handle) and move the left
...
//
// The vtkMimxBoxWidget is very flexible. It can be used to select, cut, clip, or
...
#ifndef __vtkMimxBoxWidget_h
#define __vtkMimxBoxWidget_h
...
class VTK_MIMXWIDGETS_EXPORT vtkMimxBoxWidget : public vtk3DWidget
{
public:
  // Description:
  // Instantiate the object.
  static vtkMimxBoxWidget *New();

  vtkTypeRevisionMacro(vtkMimxBoxWidget,vtk3DWidget);
  ...
  void SetInputActor (vtkActor *Actor);
...
private:
  vtkMimxBoxWidget(const vtkMimxBoxWidget&);  //Not implemented
  void operator=(const vtkMimxBoxWidget&);  //Not implemented
};
