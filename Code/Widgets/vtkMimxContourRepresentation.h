/*=========================================================================
  ...
  Module:    $RCSfile: vtkMimxContourRepresentation.h,v $
...
=========================================================================*/
// .NAME vtkMimxContourRepresentation - represent the vtkMimxContourWidget
// .SECTION Description
// The vtkMimxContourRepresentation is a superclass for various types of
// representations for the vtkMimxContourWidget.
//
// .SECTION Managing contour points
// The classes vtkMimxContourRepresentationNode, vtkMimxContourRepresentationInternals, 
// vtkMimxContourRepresentationPoint manage the data structure used to represent 
...
//
// .SECTION See Also
// vtkMimxContourWidget


#ifndef __vtkMimxContourRepresentation_h
#define __vtkMimxContourRepresentation_h
...
class vtkMimxContourLineInterpolator;
class vtkPolyData;

//----------------------------------------------------------------------
//BTX
class vtkMimxContourRepresentationPoint
{
public:
...
class vtkMimxContourRepresentationNode
{
public:
  double        WorldPosition[3];
  double        WorldOrientation[9];
  double        NormalizedDisplayPosition[2];
  vtkstd::vector<vtkMimxContourRepresentationPoint*> Points;
};

class vtkMimxContourRepresentationInternals
{
public:
  vtkstd::vector<vtkMimxContourRepresentationNode*> Nodes;
};
//ETX

class VTK_MIMXWIDGETS_EXPORT vtkMimxContourRepresentation : public vtkWidgetRepresentation
{
  //BTX  
  friend class vtkMimxContourWidget;
  friend class vtkMimxContourTraceWidget;
  //ETX
public:
  // Description:
  // Standard VTK methods.
  vtkTypeRevisionMacro(vtkMimxContourRepresentation,vtkWidgetRepresentation);
...
//ETX
  ...
  vtkSetClampMacro( CurrentOperation, int, 
                    vtkMimxContourRepresentation::Inactive,
                    vtkMimxContourRepresentation::Translate );
  void SetCurrentOperationToInactive()
    { this->SetCurrentOperation( vtkMimxContourRepresentation::Inactive ); }
  void SetCurrentOperationToTranslate()
    { this->SetCurrentOperation( vtkMimxContourRepresentation::Translate ); }
  ...
  // nodes.
  void SetLineInterpolator( vtkMimxContourLineInterpolator *);
  vtkGetObjectMacro( LineInterpolator, vtkMimxContourLineInterpolator );
...
protected:
  ...
  vtkMimxContourLineInterpolator *LineInterpolator;
  ...
  vtkMimxContourRepresentationInternals *Internal;
  ...
  void UpdateNodeLines(int nodeNum);
  ...
  // vtkMimxContourWidget::Initialize( vtkPolyData * )
  virtual void Initialize( vtkPolyData * );

private:
  vtkMimxContourRepresentation(const vtkMimxContourRepresentation&);  //Not implemented
  void operator=(const vtkMimxContourRepresentation&);  //Not implemented
};
